...
<body>
    ...
    <div id="donation-container">
        <div class="half money-donation">
            <h2>User List</h2>
            <a href="admin_view_users.php" class="donate-button">User List</a>
        </div>

        <div class="half food-donation">
            <h2>User Donation Booking</h2>
            <a href="admin_booking.php" class="donate-button">User Donation Booking</a>
        </div>
    </div>
